<%@page import="edu.kosmo.ex.gamesrp.Score"%>
<%@page import="edu.kosmo.ex.gamesrp.ScissorRockPaper"%>
...
/* 		 	Cookie[] ckis = request.getCookies();
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="list3.do">게시판</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <!-- nav-link -->
              <a class="nav-link" href="gamelotto.jsp">당첨로또 <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
