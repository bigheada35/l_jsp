				...
				<table class="table table-striped table-hover table-warning">
					...
					<tbody>
						...
						<c:forEach var="dto" items="${list}">
							...
							<c:if test="${dto.bid eq reply_view.bid}">
										<form action="reply.do" method="post">
											...
											<tr>
												<td colspan="10" bgcolor="#7fffd4">
													...
													<input type="text" name="btitle" value="${reply_view.btitle}" size="55">
													<textarea cols="120" rows="4" name="bcontent" >${reply_view.bcontent}</textarea>
												</td>
											</tr>
